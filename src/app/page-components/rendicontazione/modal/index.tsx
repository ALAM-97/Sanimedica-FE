...
const Modal = (props: ModalPropsTypes) => {
  ...
  const { open = false, onClose, currentOperator } = props;
          ...
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0 ">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all w-2/5">
                <div className="bg-white px-7 pb-4 pt-5">
                ...
                <div className="bg-gray-50 px-7 py-4 flex justify-between">
                  <button
                    type="button"
